...
// Draw the body shape
let drawBody = (graphics: Graphics.t, ~state: PlayerState.visualState, ~facing: PlayerState.facing): unit => {
...
// Draw the laptop
let drawLaptop = (graphics: Graphics.t, ~state: PlayerState.visualState, ~facing: PlayerState.facing): unit => {
  let _ = Graphics.clear(graphics)
...
// Draw laptop screen
let drawLaptopScreen = (graphics: Graphics.t, ~state: PlayerState.visualState, ~facing: PlayerState.facing): unit => {
  let _ = Graphics.clear(graphics)
